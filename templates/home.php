...
?>
    ...
    <section id="intro" class="movhid">
     ...
     <section id="intro" class="deshide">
        <?php echo do_shortcode('[rev_slider alias="res-principal"]'); ?>
    </section>
        ...
        <div class="contenedor">
            <div class="flex">
                ...
                <div class="columna">
                    ...
                    <div class="center">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/home/res-line.png" alt="adorno clauss">
                    </div>
                    
                    
                    <img class="movhid" src="<?php echo get_stylesheet_directory_uri(); ?>/img/coaching/rombos.png" alt="<>........<>">
    ...
    <section id="entrenamiento-home" class="movhid template-section">
        <div class="contenedor">
            <div class="flex">
                <div class="columna">
                    <h2>ENTRENAMIENTO
    ...
    <section id="entrenamiento-home" class="deshide template-section">
        <div class="contenedor">
